...
('content-001', 
 ...
 'https://customer-assets.emergentagent.com/job_digital-showcase-76/artifacts/8eql7633_logoAlm_yWEB-removebg-preview.png',
 'Empoderar a las empresas con soluciones digitales accesibles y de alta calidad. Creemos que cada negocio merece una presencia en linea profesional sin importar su tamano o presupuesto.',
 'Ser el socio tecnologico lider para empresas emergentes en Ecuador, transformando ideas en experiencias digitales exitosas que impulsen el crecimiento de nuestros clientes.');
...
('service-001',
 'Web Presencial',
 'Ideal para dar a conocer la informacion detallada de su negocio.',
 'Hasta 5 secciones',
 'Hosting y Dominio|Optimizacion SEO basica',
 30.00,
 30.00,
 false,
 1),
('service-002',
 'Aplicativo Web (Gestion Pro)',
 'Para administrar su propio contenido sin depender de un desarrollador.',
 'Hasta 10 secciones',
 'Hosting, Dominio y Base de Datos (Supabase)|Panel de administracion de informacion|Conexion estable y SEO incluido',
 65.00,
 30.00,
 true,
 2),
('service-003',
 ...
 'Solucion completa para negocios con funcionalidades complejas.',
 'Ilimitadas',
 'Hosting, Dominio y Base de Datos extendida (hasta 5GB)|Administracion de usuarios y cuentas de clientes|SEO Avanzado y garantia de conexion',
 110.00,
 40.00,
 false,
 3);
...
('project-001',
 ...
 'Arquitectura',
 'Sitio web minimalista para estudio de arquitectura con galeria de proyectos',
...
('project-002',
 ...
 'Salud',
 'Portal web para clinica dental con sistema de citas online',
...
('project-003',
 ...
 'Salud',
 'Plataforma integral para centro medico con multiples especialidades',
...
('project-004',
 ...
 'Retail',
 'E-commerce moderno para tienda de ropa con catalogo digital',
...
('project-005',
 'ElectroHogar Store',
 'Retail',
 'Tienda online de electrodomesticos con comparador de productos',
...
('project-006',
 ...
 'Salud',
 'Sitio web profesional para medico general con informacion de servicios',
 'https://images.unsplash.com/photo-1642975967602-653d378f3b5b?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1NzR8MHwxfHNlYXJjaHw0fHxtZWRpY2FsJTIwY2xpbmljJTIwZG9jdG9yJTIwd2Vic2l0ZSUyMGRlc2lnbiUyMG1vY2t1cHN8ZW58MHx8fHwxNzcwMjQ0MTM5fDA&ixlib=rb-4.1.0&q=85',
 '#'),
('project-007',
...
('testimonial-001',
 'Maria Gonzalez',
 'Boutique Luna',
 'Excelente servicio, nuestra pagina web ha aumentado nuestras ventas en un 40%. El equipo de Almy.W.E.B. entendio perfectamente nuestra vision.',
 5,
...
('testimonial-002',
 'Dr. Carlos Mendoza',
 'Centro Medico Vida',
 'Profesionales y puntuales. Ahora mis pacientes pueden agendar citas online facilmente. Lo recomiendo totalmente.',
 5,
...
('testimonial-003',
 ...
 'La mejor inversion para mi estudio. El diseno es elegante y mis clientes quedan impresionados con el portfolio digital.',
 5,
